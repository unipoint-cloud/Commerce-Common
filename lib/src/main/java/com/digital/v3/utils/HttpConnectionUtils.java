...
public class HttpConnectionUtils {
	...
	static {		
		...
		baseUrls.put("API-G", "http://commerce-gateway-svc");
		baseUrls.put("Auth", "http://commerce-auth-svc");
		baseUrls.put("Inventory", "http://commerce-inventory-svc");
		baseUrls.put("Product", "http://commerce-product-svc");
		baseUrls.put("Person", "http://commerce-person-svc");
		baseUrls.put("Order", "http://commerce-order-svc");
	}
